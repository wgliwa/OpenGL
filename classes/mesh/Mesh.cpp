...
////    glBindVertexArray(0);
////}
//void Mesh::load_vertices_from_file(const std::string &name) {
...
//}
//
//void Mesh::draw_with_env_map(int mode, GLuint skybox_texture){
//    prep_basic();
...
//}
//void Mesh::vertical_lean(){
//    matModel = glm::rotate(matModel, glm::radians(45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
//}
//void Mesh::hover(float angle) {
//    matModel = glm::rotate(matModel, glm::radians(-45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
//    matModel = glm::rotate(matModel, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
//    matModel = glm::rotate(matModel, glm::radians(45.0f), glm::vec3(1.0f, 0.0f, 0.0f));
//}
//void Mesh::move(float amount, char axis) {
...
//}
//void Mesh::circle_around_point(const glm::vec3& orbitCenter, float orbitRadius, float orbitSpeed, float deltaTime) {//todo
...
//}
//
//void Mesh::sendMaterialParameters() {
...
//}
//
//void Mesh::load_texture(const std::string &name) {
